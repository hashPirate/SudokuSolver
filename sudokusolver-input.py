...
# The user input is in the format of 1200210203048204892 where 0 represents empty slots or you can modify the array below
import time
import copy
'''
...
a = input('Enter a sudoku or click n for default: ').strip()
